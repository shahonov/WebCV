...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$1, 51, 8, 1780);
    			attr_dev(div, "class", "technical-skills-slide svelte-15xs4t9");
    			add_location(div, file$1, 50, 4, 1735);
    			attr_dev(section, "class", "slide svelte-15xs4t9");
    			add_location(section, file$1, 49, 0, 1691);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object_1$1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<TechnicalSkillsSlide> was created with unknown prop '${key}'`);
    	});
